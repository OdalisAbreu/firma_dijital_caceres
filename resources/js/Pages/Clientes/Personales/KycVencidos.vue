...
const aplicarFiltros = () => {
    ...
    form.estado_formulario = 'VENCIDO';
...
const kycForm = useForm({
    tipo_persona: '',
    redirect_to: route('clientes.personales.kyc-vencidos'),
    redirect_query: {
        ...(props.filters || {}),
        page: form.page,
        page_size: form.page_size,
...
const submitKyc = () => {
    ...
    kycForm.redirect_query = {
        ...
        ...(form.sucursal ? { sucursal: form.sucursal } : {}),
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <!-- <div>
                                <h3 class="text-lg font-semibold text-secondary dark:text-white">Total de Clientes Personales con KYC Vencidos</h3>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    >
                                        ...
                                        <td class="px-6 py-4 text-sm text-accent dark:text-blue-400" style="max-width: 150px; width: 150px;">
                                            <div 
                                                class="truncate" 
