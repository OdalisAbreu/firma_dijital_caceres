...
const form = useForm({
    ...
    code_employee: props.employee.code_employee || '',
    major_employee: props.employee.major_employee || false,
});
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center">
                ...
                <h2 class="font-semibold text-xl text-secondary leading-tight">Editar Empleado</h2>
            </div>
        </template>
